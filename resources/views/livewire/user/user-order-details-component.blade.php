        ...
        <div class="row">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a href="{{ route('user.orders') }}" class="btn btn-success pull-right " style="margin-left: 10px">My Orders</a>
                                    
                                @if ($order->status = 'delivered')
                                    <a href="#" class="btn btn-danger pull-right" wire:click.prevent="cancelOrder">Cancel Order</a>
                                @endif
                            </div>
                        </div>
                    </div>
                                        ...
                                        @if ($item->options)
                                            <div class="product-name">
                                                @foreach (unserialize($item->options) as $key=>$value)
                                                    <p style="font-weight: bold"><strong>{{$key}} : {{$value}}</strong></p>   
                                                @endforeach
                                            </div>
                                        @endif
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-12">BIlling Details</div>
                        </div>
                    </div>
                    <div class="panel-body">
                        <table class="table table-striped">
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-12">Transactions</div>
                        </div>
                    </div>
                    <div class="panel-body">
                        <table class="table table-striped">
